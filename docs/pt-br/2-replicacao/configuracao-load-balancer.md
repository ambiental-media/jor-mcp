...
## 1. Visão Geral
O Global External Application Load Balancer atua como o único ponto de entrada para `jor-mcp.ambiental.media`. Ele tem duas funções críticas:
...
| `jor-mcp.ambiental.media` | `/*` (Padrão) | Frontend (Backend Bucket) |
